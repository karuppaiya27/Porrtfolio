...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      access_key: "7633b195-bb42-4a52-867e-584a0f56de8b", // Your access key
      name: formData.name,
  ...
  return (
    <div id="contact" className="bg-white min-h-screen flex items-center justify-center">
        ...
        <div className="flex flex-col items-center md:flex-row gap-[150px] justify-center">
          ...
          <div className="flex flex-col space-y-5 text-lg md:text-xl font-semibold">
            ...
            <div className="flex items-center gap-3">
              ...
              <span>karuppaiya20it021@gamil.com</span>
            </div>
            <div className="flex flex-col items-center gap-3">
              <h2 className="text-xl font-bold">Follow on</h2>
              <div className="flex gap-4">
                <a href="https://github.com/karuppaiya27" className="hover:text-[#fe5617]">
                  <FaGithub size={29} />
                </a>
                <a href="https://www.linkedin.com/in/karuppaiya-m-7035022b9" className="hover:text-[#fe5617]">
                  <FaLinkedin size={29} />
                </a>
                <a href="https://www.instagram.com/offline_dreamer/" className="hover:text-[#fe5617]">
                  <FaInstagram size={29} />
                </a>
              </div>
            </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5 w-full max-w-md">
            ...
            {success === false && (
              <p className="text-red-500 text-center">Failed to send the message. Try again.</p>
            )}
          </form>
        </div>
      </div>
